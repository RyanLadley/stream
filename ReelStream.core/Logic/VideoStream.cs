...
{
    /// <summary>
    /// Allow Stream to seek.
    /// Code Source and Information can be found here:
    ...
    /// </summary>
    public class VideoStream : FileStreamResult
    {
        // default buffer size as defined in BufferedStream type
        private const int BufferSize = 0x1000;
        private string MultipartBoundary = "<qwe123>";

        public VideoStream(Stream fileStream, string contentType)
            : base(fileStream, contentType)
        {

        }

        public VideoStream(Stream fileStream, MediaTypeHeaderValue contentType)
            : base(fileStream, contentType)
        {
    ...
    public static class HttpContextEtensions
    {
