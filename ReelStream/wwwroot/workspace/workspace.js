...
/*app.run(function($rootScope, $location, $cookies){
    ...
    $rootScope.loading = false;
});*/;app.service('getRequest', ['$http', '$cookies', '$location', function ($http, $cookies, $location) {
...
app.service('postRequest', ['$http', '$cookies', '$location', function($http, $cookies, $location){
...
app.controller('movieQueueController', ['$scope', '$location', function ($scope, $location) {
